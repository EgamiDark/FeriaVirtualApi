...
// OBTIENE TODAS LAS VENTAS LOCALES PARA WEB
exports.getVentasLocalesWeb = async (req, res) => {
  try {
    const cone = await openBD();
    sql = `begin PKG_METODOS.VENTAS_LOCALES(:cursor); end;`;
